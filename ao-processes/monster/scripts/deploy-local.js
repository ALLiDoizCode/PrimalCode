...
/**
 * Local deployment script for AO monster process using AOLite
...
const AOLITE_CONFIG = {
    port: 8080,
    processName: 'monster-process-local'
};

function deployToAOLite() {
    console.log('🚀 Deploying Monster Process to AOLite...');
    ...
    try {
        ...
        const localPath = path.join(__dirname, '../monster-local.lua');
